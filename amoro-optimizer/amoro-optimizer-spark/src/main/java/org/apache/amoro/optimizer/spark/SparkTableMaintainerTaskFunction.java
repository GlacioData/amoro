...
public class SparkTableMaintainerTaskFunction
    implements Function<OptimizingTask, OptimizingTaskResult> {

  private static final Logger LOG = LoggerFactory.getLogger(SparkTableMaintainerTaskFunction.class);
  private final OptimizerConfig config;
  private final int threadId;

  public SparkTableMaintainerTaskFunction(OptimizerConfig config, int threadId) {
    this.config = config;
