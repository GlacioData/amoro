...
/**
 * Internal abstraction for committing optimizing results, used by ProcessFactory implementations.
 * Each format module provides its own committer implementation (e.g., UnKeyedTableCommit,
 * KeyedTableCommit for Iceberg).
 */
