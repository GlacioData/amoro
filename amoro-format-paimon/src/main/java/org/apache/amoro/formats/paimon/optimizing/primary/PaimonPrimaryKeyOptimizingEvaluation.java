...
public class PaimonPrimaryKeyOptimizingEvaluation {
  ...
  private final List<PaimonBucketCompactionUnit> units;
  ...
  public List<PaimonBucketCompactionUnit> units() {
    return units;
  }

  public OptimizingType optimizingType() {
    return optimizingType;
  }

  public boolean fullCompaction() {
